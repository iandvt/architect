...
- Keyboard navigation: ⌘G toggles between full and grid view, ⌘Arrow moves between slots from full view, ⌘N adds, ⌘W closes a terminal (restarts if it's the only terminal), ⌘T opens worktrees, ⌘/ opens shortcuts; quit with ⌘Q or the window close button
